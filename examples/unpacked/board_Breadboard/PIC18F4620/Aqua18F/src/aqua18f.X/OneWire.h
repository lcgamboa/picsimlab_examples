...
{
    uint8_t bitmask;
    volatile IO_REG_TYPE *port; //IO Port Register
    volatile IO_REG_TYPE *ddr;  //Data Direction Register
...
#define OneWire_write(this, v)  OneWire_write_ex(this, v, 0)
#define OneWire_write_bytes(this, buf, count) OneWire_write_bytes_ex(this, buf, count, 0)
