...
# All Configurations
ALLCONFS=18F452 18F4620 18F4550 16F877A 16F777 18F45k50 18F4520 16F1939 
...
.clobber-impl: .clobber-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=18F45k50 clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=18F4520 clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=16F1939 clean
...
.all-impl: .all-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=18F45k50 build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=18F4520 build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=16F1939 build
